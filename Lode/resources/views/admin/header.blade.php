...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            <li class=<?php if($link[3]=="user") echo "active"?>>
                <a href="{{route('user.index')}}">
                    <i class="fa fa-book"></i>
                    <span>Users</span>
                </a>
            </li>
            <li class=<?php if($link[3]=="danhde") echo "active"?>>
                <a href="{{route('danhde.index')}}">
                    <i class="fa fa-book"></i>
                    <span>Đánh đề</span>
                </a>
            </li>
            <li class=<?php if($link[3]=="kieuchoi") echo "active"?>>
                <a href="{{route('kieuchoi.index')}}">
                    <i class="fa fa-book"></i>
                    <span>Kiểu chơi</span>
                </a>
            </li>
            <li class=<?php if($link[3]=="giaodich") echo "active"?>>
                <a href="{{route('giaodich.index')}}">
                    <i class="fa fa-book"></i>
                    <span>Giao dịch</span>
                </a>
            </li>
            <li class=<?php if($link[3]=="nganhang") echo "active"?>>
                <a href="{{route('nganhang.index')}}">
                    <i class="fa fa-book"></i>
                    <span>Ngân hàng</span>
                </a>
            </li>
            <li class="header">LABELS</li>
            <li class=<?php if($link[3]=="kqxs") echo "active"?>>
                <a href="{{route('kqxs.index')}}">
                    <i class="fa fa-circle-o text-red"></i>
                    <span>Cập nhật kết quả xổ số</span>
                </a>
            </li>
            <li class=<?php if($link[3]=="ketqua") echo "active"?>>
                <a href="/ketqua">
